...
class _ScriptDownloadPageState extends ConsumerState<ScriptDownloadPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                maxLines: 3,
                minLines: 1,
                decoration: const InputDecoration(hintText: "请输入远程地址"),
                autofocus: false,
              ),
            ],
          ),
  ...
  void download(BuildContext context) async {
    ...
    try {
      ...
      var response = await _dio.get(controller.text.trim());
      EasyLoading.dismiss();
      if (response.statusCode == 200) {
        ...
        Navigator.of(context).pop({"path": f.path, "name": fileName});
      } else {
