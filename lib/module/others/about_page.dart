...
class _AboutPageState extends ConsumerState<AboutPage>
            ...
            children: [
              ...
              SettingsCard(
                ...
                child: Text(
                  ...
                  "· 全局可更换壁纸（渐变/纯色/相册/网络 + 模糊/蒙层/自动切换）\n"
                  "· 底部液态玻璃导航栏，双击导航栏/状态栏回顶部\n"
                  "· 统一毛玻璃设计，支持卡片纯色模式（可自定义颜色）\n"
                  "· 文字颜色随壁纸亮度自动反色\n"
  ...
  static Future<void> checkGithubUpdate(
    ...
    try {
      ...
      // 只认 .apk 附件：iOS 云构建 IPA 与 APK 同挂一个 release 且上传更晚，
      // 不过滤会选中 IPA（解析不出序号、时间必晚于本地构建）导致恒判有新版。
